		...
		<section class="content">
			...
			<div class="box box-primary">
					<div class="box-body">
							...
							<div class="col-md-12">
								<table id="example1" class="table table-bordered table-striped">
									...
									<tbody>
									  ...
									  <tr>
									    <td>
									      <?php echo "ข้อมูลหนี้สินกับ  <u>".$row["FinancialInstitute1"]."</u> <br/>สาขา <u>".$row["FinancialBranch1"]."</u> <br/>วงเงิน  <u>-</u> บาท <br/>แจ้งความประสงค์ขอ  <u>".$row["FinancialProcess1"]."</u>"; ?>
										  <?php 
									  ...
									  <tr>
									    <td>
									      <?php echo "ข้อมูลหนี้สินกับ  <u>".$row["FinancialInstitute2"]."</u> <br/>สาขา <u>".$row["FinancialBranch2"]."</u> <br/>วงเงิน  <u>-</u> บาท <br/>แจ้งความประสงค์ขอ  <u>".$row["FinancialProcess2"]."</u>"; ?>
										  <?php 
									  ...
									  <tr>
									    <td>
									      <?php echo "ข้อมูลหนี้สินกับ  <u>".$row["FinancialInstitute3"]."</u> <br/>สาขา <u>".$row["FinancialBranch3"]."</u> <br/>วงเงิน  <u>-</u> บาท <br/>แจ้งความประสงค์ขอ  <u>".$row["FinancialProcess3"]."</u>"; ?>
										  <?php 
									  ...
									  <tr>
									    <td>
									      <?php echo "ข้อมูลหนี้สินกับ  <u>".$row["FinancialInstitute4"]."</u> <br/>สาขา <u>".$row["FinancialBranch4"]."</u> <br/>วงเงิน  <u>-</u> บาท <br/>แจ้งความประสงค์ขอ  <u>".$row["FinancialProcess4"]."</u>"; ?>
										  <?php 
									  ...
									  <tr>
									    <td>
									      <?php echo "ข้อมูลหนี้สินกับ  <u>".$row["FinancialInstitute5"]."</u> <br/>สาขา <u>".$row["FinancialBranch5"]."</u> <br/>วงเงิน  <u>-</u> บาท <br/>แจ้งความประสงค์ขอ  <u>".$row["FinancialProcess5"]."</u>"; ?>
										  <?php 
						...
						<div class="row">
							<div class="col-md-12">
								<a href="finance.agent.management.php" class="btn btn-default pull-right"><i class="fa fa-undo"></i> หน้าหลัก</a>
								<br/>
							</div>
						</div>
						</form>
