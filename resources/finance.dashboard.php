...
<div class="wrapper clearfix" >
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
		ข้อมูลแบบแจ้งความประสงค์รับการช่วยเหลือตามมาตรการช่วยเหลือลูกค้าที่ได้รับผลกระทบจากสภาวะเศรษฐกิจ สำหรับการแพร่ระบาดของโรคติดเชื้อ COVID–19 ของธนาคารต่างๆ ในจังหวัดภูเก็ต
      </h1>
    </section>
...
<script>
  ...
  $(document).ready(function () {
    ...
    table=$('#example1').DataTable({
	  'ajax': "finance.data.php?startdate="+$('#startdate').val()+"&stopdate="+$('#stopdate').val(),
	  "columns": [
            { "data": "TransectionID" },
            { "data": "TaxID" },
            { "data": "CompanyName" },
