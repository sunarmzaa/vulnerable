...
<div class="wrapper clearfix" >
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
		แบบแจ้งความประสงค์รับการช่วยเหลือตามมาตรการช่วยเหลือผู้ประกอบการที่ได้รับผลกระทบด้านเศรษฐกิจจากสถานการณ์การแพร่ระบาดของโรคติดเชื้อ COVID–19 ของสถาบันการเงินต่างๆ ในจังหวัดภูเก็ต
      </h1>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
		  <input type="hidden" id="financeId" name="financeId" value="<?php echo $_SESSION["AUTHEN"]["OPTION1"]; ?>">
		  <input type="hidden" id="branchId" name="branchId" value="<?php echo $_SESSION["AUTHEN"]["OPTION2"]; ?>">
...
<script>
  ...
  $(document).ready(function () {
	...
	//alert("finance.data2.php?startdate="+$('#startdate').val()+"&stopdate="+$('#stopdate').val()+"&finance="+$('#financeId').val()+"&branch="+$('#branchId').val());
	
    table=$('#example1').DataTable({
	  'ajax': "finance.data2.php?startdate="+$('#startdate').val()+"&stopdate="+$('#stopdate').val()+"&finance="+$('#financeId').val()+"&branch="+$('#branchId').val(),
	  "columns": [
            { "data": "TransectionID" },
            { "data": "TaxID" },
            { "data": "CompanyName" },
