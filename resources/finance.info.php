  ...
  if (isset($_POST['submit1'])){
	...
	if(count($financeListId)>0){
		for($i=0; $i<count($financeListId); $i++){
			...
			$comment="";
			if(trim($_POST['mgs'.$financeListId[$i]])!=""){
			  ...
			  if($_POST['previousComment'.$financeListId[$i]]!=""){
				$comment=$_POST['previousComment'.$financeListId[$i]];
			  }
			}
		...
		<section class="content">
			...
			<div class="box box-primary">
					<div class="box-body">
							...
							<div class="col-md-12">
								<table id="example1" class="table table-bordered table-striped">
									...
									<tbody>
									  ...
									  <?php
										$financeListId="";
										if($row["FinancialInstitute1"]==$_SESSION["AUTHEN"]["OPTION1"] && $row["FinancialBranch1"]==$_SESSION["AUTHEN"]["OPTION2"]){ 
										  $financeListId.="1";
									  ?>
										  <tr>
											<td>
												<?php echo "ข้อมูลหนี้สินกับ  <u>".$row["FinancialInstitute1"]."</u> <br/>สาขา <u>".$row["FinancialBranch1"]."</u>  <br/>วงเงิน  <u>".number_format(decode($row["FinancialAmount1"], $_SESSION["AUTHEN"]["OPTION1"]), 2)."</u> บาท <br/>แจ้งความประสงค์ขอ  <u>".$row["FinancialProcess1"]."</u>"; ?>
												<?php 
											...
											<td>
												<select id='status1' name='status1' class='form-control select2' style='width: 100%;'>
													<option value='รอดำเนินการ' <?php if($row["FinancialStatus1"]=="" || $row["FinancialStatus1"]=="รอดำเนินการ"){ echo "selected";}?>>รอดำเนินการ</option>
													<option value='กำลังดำเนินการ' <?php if($row["FinancialStatus1"]=="กำลังดำเนินการ"){ echo "selected";}?>>กำลังดำเนินการ</option>
													<option value='ปฏิเสธ' <?php if($row["FinancialStatus1"]=="ปฏิเสธ"){ echo "selected";}?>>ปฏิเสธ</option>
													<option value='ยอมรับ' <?php if($row["FinancialStatus1"]=="ยอมรับ"){ echo "selected";}?>>ยอมรับ</option>
												</select>
											</td>
											<td>
												<?php
												...
												?>
												<input id="duedate1" name="duedate1" type="text" class="form-control" onkeydown="return false" value="<?php echo $dueDate1; ?>"> <!--echo "11/05/2020";-->
											</td>
											<td>
												<input type="hidden" id="previousComment1" name="previousComment1" value="<?php echo $row["FinancialComment1"]; ?>">
												<textarea id="mgs1" name="mgs1" class="form-control"></textarea>
											</td>
										  </tr>
									  <?php } ?>
									  ...
									  <?php
										if($row["FinancialInstitute2"]==$_SESSION["AUTHEN"]["OPTION1"] && $row["FinancialBranch2"]==$_SESSION["AUTHEN"]["OPTION2"]){ 
										  $financeListId.=",2";
									  ?>
										  <tr>
											<td>
											  <?php echo "ข้อมูลหนี้สินกับ  <u>".$row["FinancialInstitute2"]."</u> <br/>สาขา <u>".$row["FinancialBranch2"]."</u> <br/>วงเงิน  <u>".number_format(decode($row["FinancialAmount2"], $_SESSION["AUTHEN"]["OPTION1"]), 2)."</u> บาท <br/>แจ้งความประสงค์ขอ  <u>".$row["FinancialProcess2"]."</u>"; ?>
											  <?php 
											...
											<td>
												<select id='status2' name='status2' class='form-control select2' style='width: 100%;'>
													<option value='รอดำเนินการ' <?php if($row["FinancialStatus2"]=="" || $row["FinancialStatus2"]=="รอดำเนินการ"){ echo "selected";}?>>รอดำเนินการ</option>
													<option value='กำลังดำเนินการ' <?php if($row["FinancialStatus2"]=="กำลังดำเนินการ"){ echo "selected";}?>>กำลังดำเนินการ</option>
													<option value='ปฏิเสธ' <?php if($row["FinancialStatus2"]=="ปฏิเสธ"){ echo "selected";}?>>ปฏิเสธ</option>
													<option value='ยอมรับ' <?php if($row["FinancialStatus2"]=="ยอมรับ"){ echo "selected";}?>>ยอมรับ</option>
												</select>
											</td>
											<td>
												<?php
													if(is_null($row["FinancialDueDate2"])){ 
												...
												?>
												<input id="duedate2" name="duedate2" type="text" class="form-control" onkeydown="return false" value="<?php echo $dueDate2; ?>"> <!--echo "11/05/2020";-->
											</td>
											<td>
												<input type="hidden" id="previousComment2" name="previousComment2" value="<?php echo $row["FinancialComment2"]; ?>">
												<textarea id="mgs2" name="mgs2" class="form-control"></textarea>
											</td>
										  </tr>
									  <?php } ?>
									  ...
									  <?php
										if($row["FinancialInstitute3"]==$_SESSION["AUTHEN"]["OPTION1"] && $row["FinancialBranch3"]==$_SESSION["AUTHEN"]["OPTION2"]){ 
										  $financeListId.=",3";
									  ?>
										  <tr>
											<td>
											  <?php echo "ข้อมูลหนี้สินกับ  <u>".$row["FinancialInstitute3"]."</u> <br/>สาขา <u>".$row["FinancialBranch3"]."</u> <br/>วงเงิน  <u>".number_format(decode($row["FinancialAmount3"], $_SESSION["AUTHEN"]["OPTION1"]), 2)."</u> บาท <br/>แจ้งความประสงค์ขอ  <u>".$row["FinancialProcess3"]."</u>"; ?>
											  <?php 
											...
											<td>
												<select id='status3' name='status3' class='form-control select2' style='width: 100%;'>
													<option value='รอดำเนินการ' <?php if($row["FinancialStatus3"]=="" || $row["FinancialStatus3"]=="รอดำเนินการ"){ echo "selected";}?>>รอดำเนินการ</option>
													<option value='กำลังดำเนินการ' <?php if($row["FinancialStatus3"]=="กำลังดำเนินการ"){ echo "selected";}?>>กำลังดำเนินการ</option>
													<option value='ปฏิเสธ' <?php if($row["FinancialStatus3"]=="ปฏิเสธ"){ echo "selected";}?>>ปฏิเสธ</option>
													<option value='ยอมรับ' <?php if($row["FinancialStatus3"]=="ยอมรับ"){ echo "selected";}?>>ยอมรับ</option>
												</select>
											</td>
											<td>
												<?php
													if(is_null($row["FinancialDueDate3"])){ 
												...
												?>
												<input id="duedate3" name="duedate3" type="text" class="form-control" onkeydown="return false" value="<?php echo $dueDate3; ?>"> <!--echo "11/05/2020";-->
											</td>
											<td>
												<input type="hidden" id="previousComment3" name="previousComment3" value="<?php echo $row["FinancialComment3"]; ?>">
												<textarea id="mgs3" name="mgs3" class="form-control"></textarea>
											</td>
										  </tr>
									  <?php } ?>
									  
									  <?php
										if($row["FinancialInstitute4"]==$_SESSION["AUTHEN"]["OPTION1"] && $row["FinancialBranch4"]==$_SESSION["AUTHEN"]["OPTION2"]){ 
										  $financeListId.=",4";
									  ?>
										  <tr>
											<td>
											  <?php echo "ข้อมูลหนี้สินกับ  <u>".$row["FinancialInstitute4"]."</u> <br/>สาขา <u>".$row["FinancialBranch4"]."</u> <br/>วงเงิน  <u>".number_format(decode($row["FinancialAmount4"], $_SESSION["AUTHEN"]["OPTION1"]), 2)."</u> บาท <br/>แจ้งความประสงค์ขอ  <u>".$row["FinancialProcess4"]."</u>"; ?>
											  <?php 
											...
											<td>
												<select id='status4' name='status4' class='form-control select2' style='width: 100%;'>
													<option value='รอดำเนินการ' <?php if($row["FinancialStatus4"]=="" || $row["FinancialStatus4"]=="รอดำเนินการ"){ echo "selected";}?>>รอดำเนินการ</option>
													<option value='กำลังดำเนินการ' <?php if($row["FinancialStatus4"]=="กำลังดำเนินการ"){ echo "selected";}?>>กำลังดำเนินการ</option>
													<option value='ปฏิเสธ' <?php if($row["FinancialStatus4"]=="ปฏิเสธ"){ echo "selected";}?>>ปฏิเสธ</option>
													<option value='ยอมรับ' <?php if($row["FinancialStatus4"]=="ยอมรับ"){ echo "selected";}?>>ยอมรับ</option>
												</select>
											</td>
											<td>
												<?php
													if(is_null($row["FinancialDueDate4"])){ 
												...
												?>
												<input id="duedate4" name="duedate4" type="text" class="form-control" onkeydown="return false" value="<?php echo $dueDate4; ?>"> <!--echo "11/05/2020";-->
											</td>
											<td>
												<input type="hidden" id="previousComment4" name="previousComment4" value="<?php echo $row["FinancialComment4"]; ?>">
												<textarea id="mgs4" name="mgs4" class="form-control"></textarea>
											</td>
										  </tr>
									  <?php } ?>
									  
									  <?php
										if($row["FinancialInstitute5"]==$_SESSION["AUTHEN"]["OPTION1"] && $row["FinancialBranch5"]==$_SESSION["AUTHEN"]["OPTION2"]){ 
										  $financeListId.=",5";
									  ?>
										  <tr>
											<td>
											  <?php echo "ข้อมูลหนี้สินกับ  <u>".$row["FinancialInstitute5"]."</u> <br/>สาขา <u>".$row["FinancialBranch5"]."</u> <br/>วงเงิน  <u>".number_format(decode($row["FinancialAmount5"], $_SESSION["AUTHEN"]["OPTION1"]), 2)."</u> บาท <br/>แจ้งความประสงค์ขอ  <u>".$row["FinancialProcess5"]."</u>"; ?>
											  <?php 
												if($row["FinancialComment4"]!=""){
												  echo "<br/><br/><u>ประวัติการดำเนินการ</u><br/>";
												  echo $row["FinancialComment4"];
											...
											<td>
												<select id='status5' name='status5' class='form-control select2' style='width: 100%;'>
													<option value='รอดำเนินการ' <?php if($row["FinancialStatus5"]=="" || $row["FinancialStatus5"]=="รอดำเนินการ"){ echo "selected";}?>>รอดำเนินการ</option>
													<option value='กำลังดำเนินการ' <?php if($row["FinancialStatus5"]=="กำลังดำเนินการ"){ echo "selected";}?>>กำลังดำเนินการ</option>
													<option value='ปฏิเสธ' <?php if($row["FinancialStatus5"]=="ปฏิเสธ"){ echo "selected";}?>>ปฏิเสธ</option>
													<option value='ยอมรับ' <?php if($row["FinancialStatus5"]=="ยอมรับ"){ echo "selected";}?>>ยอมรับ</option>
												</select>
											</td>
											<td>
												<?php
													if(is_null($row["FinancialDueDate5"])){ 
												...
												?>
												<input id="duedate5" name="duedate5" type="text" class="form-control" onkeydown="return false" value="<?php echo $dueDate5; ?>"> <!--echo "11/05/2020";-->
											</td>
											<td>
												<input type="hidden" id="previousComment5" name="previousComment5" value="<?php echo $row["FinancialComment5"]; ?>">
												<textarea id="mgs5" name="mgs5" class="form-control"></textarea>
											</td>
										  </tr>
									  <?php } ?>
								...
								<input type="hidden" id="financeListId" name="financeListId" value="<?php echo $financeListId; ?>">
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="form-inline">
									...
									<a href="finance.management.php" class="btn btn-default pull-right" style="margin: 5px;"><i class="fa fa-undo"></i> หน้าหลัก</a>
									<br/>
								</div>
						...
						<div class="row">
							<div class="col-md-12">
								<button id="submit2" name="submit2" type="submit" class="btn btn-primary pull-right" style="margin: 5px;"><i class="fa fa-save"></i> บันทึกข้อมูล</button>
								<br/>
							</div>
						</div>
						</form>
